...
export const majlisData = {
  hero: {
    ...
    logo: `${import.meta.env.BASE_URL}img/desain-majlis-ta'alim/logo.avif`,
    banner: `${import.meta.env.BASE_URL}img/desain-majlis-ta'alim/banner-zikir.avif`,
  },
  invitation: {
    ...
    image: `${import.meta.env.BASE_URL}img/desain-majlis-ta'alim/undangan.avif`,
  },
  certificate: {
  ...
  poster: {
    ...
    image: `${import.meta.env.BASE_URL}img/desain-majlis-ta'alim/poster.avif`,
  },
  ornaments: {
    cornerBL: `${import.meta.env.BASE_URL}img/desain-majlis-ta'alim/ornament-corner-bl.avif`,
    cornerBR: `${import.meta.env.BASE_URL}img/desain-majlis-ta'alim/ornament-corner-br.avif`,
  },
};
