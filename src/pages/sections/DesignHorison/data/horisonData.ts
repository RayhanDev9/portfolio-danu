...
export const horisonData = {
  hero: {
    ...
    logo: `${VENDOR}/horison.avif`,
    instagramHandle: "horisonaltamapandeglang",
    personImage: `${PROFILE}/danu.avif`,
    previewBanners: [
      {
        title: "Meeting Room Package",
        price: "IDR 300.000",
        image: `${DIR}/meeting-room/meeting-room-2.avif`,
        tag: "MEETING ROOM",
      },
      {
        title: "Marry Me - Wedding Package",
        price: "IDR 14.800.000",
        image: `${DIR}/weeding/weeding-1.avif`,
        tag: "WEDDING",
      },
    ],
  },
  meetingRoom: {
    ...
    featuredBanner: `${DIR}/meeting-room/metting-room-1.avif`,
    cards: [
      {
        id: 1,
      ...
      },
      {
        ...
        image: `${DIR}/meeting-room/meeting-room-4.avif`,
        price: "IDR 450.000",
      },
      {
        id: 3,
        title: "Meeting Package Facilities",
        image: `${DIR}/meeting-room/meetingroom-3.avif`,
        price: "IDR 300.000",
      },
      {
        id: 4,
        title: "Meeting Room Showcase",
        image: `${DIR}/meeting-room/metting-room-5.avif`,
        price: "IDR 300.000",
      },
    ],
  },
  wedding: {
    ...
    thumbnails: [
      ...
      },
      {
        ...
        image: `${DIR}/weeding/weeding-3.avif`,
        price: "IDR 14.800.000 nett",
      },
    ],
    mainPoster: `${DIR}/weeding/weeding-2.avif`,
  },
  hotelRoom: {
    sectionTitle: "DESIGN",
    ...
    promoPosters: [
      {
        ...
        image: `${DIR}/hotel-room/hotel-room-1.avif`,
      },
      {
        id: 2,
        title: "July Day Staycation",
        price: "Starts From IDR 575.000",
        image: `${DIR}/hotel-room/hotel-room-2.avif`,
      },
      {
        id: 3,
