...
export default function GardeningSection() {
  ...
  return (
    <section
      ...
      style={{
        backgroundImage: `url('${gardening.bg}')`,
      }}
    >
      {/* Overlay Taman Hijau */}
      ...
      {/* 2. Grid 4 Kartu Postingan Tema Berkebun & Sayuran (1 Baris x 4 Kolom di Desktop) */}
      <div className="relative z-10 w-full max-w-6xl mx-auto mb-8 sm:mb-12">
        <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-5">
          {gardening.cards.map((card) => (
            <div
              key={card.id}
