...
export default function FitnessSection() {
  ...
  return (
    <section
      ...
      style={{
        backgroundImage: `url('${fitness.bg}')`,
      }}
    >
      {/* Overlay Home Gym Minimalis */}
