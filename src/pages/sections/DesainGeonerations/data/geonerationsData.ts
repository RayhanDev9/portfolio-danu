...
export const GEONERATIONS_BG = `${DIR}/bg/bg.avif`;
...
export const DESIGN_FEEDS: DesignItem[] = [
  {
    ...
    category: "feed",
    image: `${DIR}/dsign-feed/pildun2.avif`,
  ...
  },
  {
    ...
    category: "feed",
    image: `${DIR}/dsign-feed/party ngombe alkohol wes gak jaman.avif`,
  ...
  },
  {
    ...
    category: "feed",
    image: `${DIR}/dsign-feed/GIVEAWAY KARTU POKEMON.avif`,
  ...
  },
  {
    ...
    category: "feed",
    image: `${DIR}/dsign-feed/nongkrong berhadiah.avif`,
...
export const CAROUSEL_KOPI_ITEMS: DesignItem[] = [
  {
    ...
    image: `${DIR}/carousel/KOPI SING GAK COCOK GAWE KONCO ROKOKAN.avif`,
  ...
  },
  {
    ...
    title: "Kopi Visual",
    category: "carousel-kopi",
    image: `${DIR}/carousel/KOPI VISUAL.avif`,
  ...
  },
  {
    ...
    title: "Kopi Paste",
    category: "carousel-kopi",
    image: `${DIR}/carousel/kopi paste.avif`,
  ...
  },
  {
    ...
    title: "Kopi Kutah",
    category: "carousel-kopi",
    image: `${DIR}/carousel/KOPI KUTAH.avif`,
...
export const OTHER_DESIGN_ITEMS: DesignItem[] = [
  {
    ...
    title: "Pulang",
    category: "other",
    image: `${DIR}/other-design/arek geo.avif`,
  ...
  },
  {
    ...
    category: "other",
    image: `${DIR}/other-design/dino pertama gta rilis.avif`,
  ...
  },
  {
    ...
    category: "other",
    image: `${DIR}/other-design/coba minum kopi.avif`,
  ...
  },
  {
    ...
    category: "other",
    image: `${DIR}/other-design/Bahasa jawa-nya tanah.avif`,
  ...
  },
  {
    ...
    category: "other",
    image: `${DIR}/other-design/di kejar pocong.avif`,
    alt: "Robot Duit 3D",
  },
  {
    id: "other-6",
    ...
    category: "other",
    image: `${DIR}/other-design/Gawe konco-koncoku sing wes suwe gak info ngopi.avif`,
  ...
  },
  {
    ...
    category: "other",
    image: `${DIR}/other-design/ONOK KONCOKU SING NGANGETI JAJAN KOYO NGENE.avif`,
  ...
  },
  {
    ...
    category: "other",
    image: `${DIR}/other-design/Ngopi adalah cara bertahan hidup_.avif`,
  ...
  },
  {
    ...
    category: "other",
    image: `${DIR}/other-design/kondisi jatim.avif`,
  ...
  },
  {
    ...
    category: "other",
    image: `${DIR}/other-design/KESENJANGAN SOSIAL….avif`,
  ...
  },
  {
    ...
    category: "other",
    image: `${DIR}/other-design/iki piye karepe.avif`,
  ...
  },
  {
    ...
    category: "other",
    image: `${DIR}/other-design/Iki manuk opo yo Lur.avif`,
